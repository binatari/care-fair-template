...
import { onLogin, } from "../../../src/utils/agencyQueries";
...
const index = () => {
  ...
  React.useEffect(()=>{
    if(isSuccess){
      ...
      setCookie(null, 'agencyInfo', JSON.stringify(innerData.data), {
        path: "/",
        maxAge: 60 * 60 * 24 * 30, // Expires after a month
        sameSite: true,
      })
       localStorage.setItem('agencyToken', innerData.data.api_token)
